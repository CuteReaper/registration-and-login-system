...
<form class="max-w-sm mx-auto" action="../controller/register.php" method="POST">
<div class="mb-5">
  <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your username</label>
    ...
    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your l name</label>
